...
final class ShipButtonsCreator: ShipButtonCreatorUseCase {
    ...
    func createThrustButton() {
        let thrustSprite = AssetImage.thrustButton.swashScaledSprite
    ...
    func createLeftButton() {
        let leftSprite = AssetImage.leftButton.swashScaledSprite
    ...
    func createRightButton() {
        let rightSprite = AssetImage.rightButton.swashScaledSprite
    ...
    func createFlipButton() {
        let flipSprite = AssetImage.flipButton.swashScaledSprite
    ...
    func createFireButton() {
        let fireSprite = AssetImage.fireButton.swashScaledSprite
    ...
    func createHyperspaceButton() {
        let hyperspaceSprite = AssetImage.hyperspaceButton.swashScaledSprite
        let thrustSprite = SwashScaledSpriteNode(imageNamed: .thrustButton)
        let thrustX = size.width - thrustSprite.size.width / 2 - buttonPaddingRight
